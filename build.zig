...
pub fn build(b: *std.build.Builder) void {
    ...
    const verify_tests = &[_]VerifyTest{
        ...
        VerifyTest.hello(.build, &[_][]const u8{"--format=compact"}),
        VerifyTest.ok(.build, "samples/fizzbuzz.wala", &[_][]const u8{"--format=compact"}),
        VerifyTest.help(.run),
        ...
        VerifyTest.ok(.run, "samples/99-bottles-of-beer.wala", null),
        VerifyTest.ok(.run, "samples/fizzbuzz.wala", null),
